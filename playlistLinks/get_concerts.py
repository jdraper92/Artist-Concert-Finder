...
class BandInfo:
    def __init__(self,city):
        ...
        self.formatted_date = ''
        self.hash_table = {}
        self.cities = {'chicago':'9426-us-chicago','boston':'18842-us-boston-cambridge',\
         'losangeles':'17835-us-los-angeles','newyork':'7644-us-new-york','austin':'9179-us-austin',\
         'washington':'1409-us-washington'}
        self.city = city
    ...
    def makeUrl(self):
        ...
        url = 'http://www.songkick.com/metro_areas/' + self.cities[self.city] + '?utf8=%E2%9C%93&filters%5BminDate%5D=' + self.month + '%2F' + self.day + '%2F' + self.year + '&filters%5BmaxDate%5D=' + self.month + '%2F' + self.day + '%2F' + self.year + '#date-filter-form'
        #url = 'http://www.songkick.com/metro_areas/9426-us-chicago?utf8=%E2%9C%93&filters%5BminDate%5D=%s%2F%s%2F%s&filters%5BmaxDate%5D=%s%2F%s%2F%s#date-filter-form' % (self.month,self.day,self.year,self.month,self.day,self.year)
    ...
    def makeDict(self,date):
        ...
        return list(bands_and_locations)
